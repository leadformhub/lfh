  ...
  if (submitted) {
    return (
      <div className="mt-10 rounded-xl border border-[var(--color-success)]/30 bg-green-50 p-6 text-center">
        ...
        <p className="mt-1 text-base text-[var(--foreground-muted)]">We&apos;ll respond to your request shortly.</p>
        <button
          type="button"
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-10 space-y-6">
      ...
      <p className="text-base text-[var(--foreground-muted)]">
        Prefer email? See our <Link href="/contact" className="font-medium text-[var(--color-accent)] hover:underline">contact page</Link> or browse the{" "}
        <Link href="/knowledge-base" className="font-medium text-[var(--color-accent)] hover:underline">knowledge base</Link> first.
      </p>
    </form>
  );
}
